...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'bf-mindstate':
				var tex = Paths.getSparrowAtlas('characters/MindStateBf', 'shared');
				frames = tex;
			...
			case 'boss':
				tex = Paths.getSparrowAtlas('characters/boss_assets');
				frames = tex;
				animation.addByPrefix('idle', 'boss idle', 24, false);
				...
				addOffset('idle');
				addOffset("singUP", 17, -7);
				addOffset("singRIGHT", -34, -25);
