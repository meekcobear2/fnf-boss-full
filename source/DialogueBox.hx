...
class DialogueBox extends FlxSpriteGroup
{
	...
	public function new(talkingRight:Bool = true, ?dialogueList:Array<String>)
	{
		...
		else if (PlayState.SONG.song.toLowerCase() == 'welcome' || PlayState.SONG.song.toLowerCase() == 'fustration')
		{
			...
			portraitLeft.animation.addByPrefix('enter', 'bossPortrait idle', 24, false);
		...
		if (PlayState.SONG.song.toLowerCase() == 'senpai' || PlayState.SONG.song.toLowerCase() == 'roses' || PlayState.SONG.song.toLowerCase() == 'thorns')
		{
			portraitRight = new FlxSprite(-200, 40);
		...
		else if (PlayState.SONG.song.toLowerCase() == 'welcome' || PlayState.SONG.song.toLowerCase() == 'fustration')
		{
			...
			portraitRight.animation.addByPrefix('enter', 'bfPortrait idle', 24, false);
		...
		if (PlayerSettings.player1.controls.ACCEPT && dialogueStarted == true)
		{
			...
			if (dialogueList[1] == null && dialogueList[0] != null)
			{
				if (!isEnding)
				{
					...
					if (PlayState.SONG.song.toLowerCase() == 'senpai' || PlayState.SONG.song.toLowerCase() == 'thorns' || PlayState.SONG.song.toLowerCase() == 'welcome')
